...
The server doesn't allow Discord invite links to be sent. You may send them to users in DMs upon request, however they cannot be sent in the server itself.

Feel free to rejoin the ImmersiveMC Discord server if you want. No worries if you don't, though! If you have any questions, comments, or concerns, feel free to message <@195239733553659904>"""
